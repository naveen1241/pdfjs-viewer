...
// Add a listener for messages from the parent frame to handle scrolling.
window.addEventListener('message', (event) => {
    // Ensure the message is what we expect.
    if (event.data && event.data.type === 'scroll-to-page') {
...
// Optionally, send a message back to the parent to confirm the viewer is ready.
